    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            with open(r'C:\Users\Prathamesh\MLOPS\mlops_project_1\tinmestamp_logs.txt','a') as f:
                f.write(f'inside data_transformation.py, trainedfilepath is {self.data_ingestion_artifact.trained_file_path}\n')
                f.write(f'inside data_transformation.py, testfilepath is {self.data_ingestion_artifact.test_file_path}\n')
            ...
            print('input_feature_train_final',type(input_feature_train_final))
            print('target_feature_train_final',type(target_feature_train_final))
