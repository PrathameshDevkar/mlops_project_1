...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_config: DataValidationConfig):
        ...
        try:
            ...
            print('_schema_config is ',self._schema_config)
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            with open(r'C:\Users\Prathamesh\MLOPS\mlops_project_1\tinmestamp_logs.txt','a') as f:
                f.write(f'inside data_validation.py, trainedfilepath is {self.data_ingestion_artifact.trained_file_path}\n')
                f.write(f'inside data_validation.py, testfilepath is {self.data_ingestion_artifact.test_file_path}\n')
            ...
            with open(self.data_validation_config.validation_report_file_path, "a") as report_file:
