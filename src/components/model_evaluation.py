...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            with open(r'C:\Users\Prathamesh\MLOPS\mlops_project_1\tinmestamp_logs.txt','a') as f:
                        f.write(f'inside model_evaluation.py evaluate_model funstion, trained_model_file_path is {self.model_trainer_artifact.trained_model_file_path}\n')
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            with open(r'C:\Users\Prathamesh\MLOPS\mlops_project_1\tinmestamp_logs.txt','a') as f:
                f.write(f'inside model_evaluation.py initiate_model_evaluation funstion, trained_model_file_path is {self.model_trainer_artifact.trained_model_file_path}\n')
